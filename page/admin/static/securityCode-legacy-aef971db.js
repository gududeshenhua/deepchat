  ...
  function r() {
    ...
    function h(t, r, e, n) {
      var o = r && r.prototype instanceof w ? r : w,
        ...
        c = new N(n || [])
      return (a(i, '_invoke', { value: O(t, e, c) }), i)
    }
    function p(t, r, e) {
      try {
    ...
    return (
      ...
      (b.displayName = l(x, s, 'GeneratorFunction')),
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (f = c('')),
                              (s = u('div', [
                                u('p', e('common.pleaseEnterSecurityCode')),
                                u('input', {
                                  id: 'security-code-input',
                                  type: 'text',
                                  placeholder: e('common.securityCodePlaceholder'),
                                  style: {
                                    width: '100%',
                                    padding: '8px',
                                    marginTop: '10px',
                              ...
                              (t.next = 5),
                              i.confirm(s, e('common.securityVerification'), {
                                          ...
                                          for (;;)
                                            switch ((t.prev = t.next)) {
                                              case 0:
                                                ...
                                                return (
                                                  a.warning(e('common.securityCodeRequired')),
                                                  t.abrupt('return')
                                                )
                                              case 4:
                                                return (
                                              ...
                                              case 8:
                                                ;((i.confirmButtonLoading = !1), c(), (t.next = 15))
                                                break
                                              case 12:
                                                ;((t.prev = 12),
                                                  (t.t0 = t.catch(4)),
                          ...
                          case 5:
                            return ((l = t.sent), t.abrupt('return', 'confirm' === l))
                          case 9:
