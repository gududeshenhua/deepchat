!(function () {
  ...
  function e() {
    ...
    function p(t, e, r, n) {
      var o = e && e.prototype instanceof b ? e : b,
        ...
        u = new N(n || [])
      return (a(i, '_invoke', { value: k(t, r, u) }), i)
    }
    function h(t, e, r) {
      try {
    ...
    var O = Object.getPrototypeOf,
      L = O && O(O(T([])))
    L && L !== o && i.call(L, c) && (j = L)
    var _ = (x.prototype = b.prototype = Object.create(j))
    function E(t) {
    ...
    function M(t, e) {
      ...
      if (o === r)
        return (
          ...
          ('throw' === n &&
            t.iterator.return &&
            ((e.method = 'return'), (e.arg = r), M(t, e), 'throw' === e.method)) ||
            ('return' !== n &&
              ((e.method = 'throw'),
  ...
  System.register(
    ...
    function (t, r) {
      'use strict'
      var o, a, u, c, l, f, s, p, h, y, v, d, g, m, b, w, x, j, O, L
      return {
        setters: [
          function (t) {
            o = t.u
                    ...
                    var i = r.emit,
                      ...
                      M = s({
                        note: [
                          {
                            required: !0,
                            message: l('groupManagement.batchModifyGroupRequired'),
                            trigger: 'change'
                          }
                        ]
                      }),
                              ...
                              function (t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    ...
                                    case 3:
                                      ;((r = t.sent), (S.value = r || []), (t.next = 11))
                                      break
                                    case 7:
                                      ;((t.prev = 7),
                                        (t.t0 = t.catch(0)),
                                        console.error('获取分组列表失败:', t.t0),
                                        c.error(l('groupManagement.getGroupListFailed')))
                                    case 11:
                                    case 'end':
                                      return t.stop()
                                  }
                            ...
                            return e().wrap(
                              function (t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      return ((t.prev = 0), (t.next = 3), T.value.validate())
                                    case 3:
                                      t.next = 8
                                      break
                                    case 5:
                                    ...
                                    case 8:
                                      return (
                                        (t.prev = 8),
                                        (r = _.padCodes.map(function (t) {
                                          return {
                                            instance_id: t,
                                            update_data: {
                                              instance_name: t,
                                              local_group_uuid: k.note
                                            }
                                          }
                                        })),
                                        (t.next = 12),
                                    ...
                                    case 12:
                                      ;(c.success(l('groupManagement.batchModifyGroupSuccess')),
                                        E('success'),
                                        N(),
                                        (t.next = 21))
                                      break
                                    case 17:
                                      ;((t.prev = 17),
                                        (t.t1 = t.catch(8)),
                                        console.error(t.t1),
                                        c.error(l('groupManagement.batchModifyGroupFailed')))
                                    case 21:
                                    case 'end':
                                      return t.stop()
                                  }
                    ...
                    return function (t, e) {
                      ...
                      return (
                        ...
                        d(
                          ...
                          {
                            'model-value': P.value,
                            title: x(l)('groupManagement.batchModifyGroupTitle'),
                            width: '500px',
                            'before-close': N
                          },
                          {
                            footer: g(function () {
                              return [
                                m(
                                  ...
                                  {
                                    default: g(function () {
                                      return [b(w(x(l)('groupManagement.cancelButtonText')), 1)]
                                    }),
                                    _: 1
                                  }
                                ),
                                m(
                                  ...
                                  {
                                    default: g(function () {
                                      return [b(w(x(l)('groupManagement.confirmButtonText')), 1)]
                                    }),
                                    _: 1
                                  }
                                )
                                    ...
                                    default: g(function () {
                                      return [
                                        m(
                                          o,
                                          {
                                            label: x(l)('groupManagement.batchModifyGroupLabel'),
                                            prop: 'note'
                                          },
                                          {
                                            default: g(function () {
                                              return [
                                                m(
                                                  n,
                                                  {
                                                    ...
                                                    placeholder: x(l)(
                                                      'groupManagement.batchModifyGroupPlaceholder'
                                                    ),
                                                    style: { width: '100%' }
                                                  },
                                                  {
